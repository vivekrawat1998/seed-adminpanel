...
export interface ApiAccelartorRequestAccelartorRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'accelartor_requests';
  info: {
    displayName: 'accelartor';
    pluralName: 'accelartor-requests';
    singularName: 'accelartor-request';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Declaration: Schema.Attribute.Boolean;
    ...
    >;
    RegistrationNumber: Schema.Attribute.BigInteger;
    State: Schema.Attribute.String;
    TypeofOrganization: Schema.Attribute.Enumeration<
      [
        'FPO/FPC',
...
export interface ApiBreederRequestBreederRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'breeder_requests';
  info: {
    displayName: 'breeder';
    pluralName: 'breeder-requests';
    singularName: 'breeder-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::breeder-request.breeder-request'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface PluginAuditLogsLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    userDisplayName: Schema.Attribute.String;
